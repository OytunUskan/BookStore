...
#*****************************************************************************************************************  
"""
    This section made for superuser. superuser create Author,Book etc. with ModelForms. 
"""
...
class AuthorUpdate(UpdateView):
    model = Author
    fields = ['first_name','last_name','date_of_birth','date_of_death','author_description']
...
class BookUpdate(UpdateView):
    model = Book
    fields = ['title','author','bookimage','summary','isbn','genre']
